function CreatedLevels() {
  ...
  this.showLevels = function() {
    ...
    if (totalStoredLevels != 0) {
      ...
      view.setHTML(noMapsMessage, 'No hay mapas guardados actualmente. Utilice el editor de niveles para crear mapas personalizados.');
  ...
  this.startLevel = function(i) {
    ...
    var map = { 1: level }; //siempre solo un nivel en los mapas guardados
...
//elimina todos los niveles creados en pantalla, para que pueda iniciarse nuevamente mostrando los nuevos niveles que crea el usuario       
