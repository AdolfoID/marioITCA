function Mario() {
  ...
  this.checkMarioType = function() {
    if (that.type == 'big') {
      ...
      //posición del gran sprite de mario
      if (that.invulnerable) {
        that.sY = 276; //si es invulnerable, muestra mario transparente
      } else {
        that.sY = 90;
      }
      ...
      // pequeño mario sprite
      if (that.invulnerable) {
        that.sY = 222; //si es invulnerable, muestra mario transparente
      } else {
        that.sY = 4;
      }
